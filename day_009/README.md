...
While working on it, I learned how to add, update and go through dictionary values, and how to get specific information from nested data. I also had a small bug when finding the highest bid because I mixed up the bidder's name and the bid amount. After figuring out what was wrong, I separated them into two variables and the program worked correctly.
uction completed`.